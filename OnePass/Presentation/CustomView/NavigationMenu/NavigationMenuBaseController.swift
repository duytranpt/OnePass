...
class NavigationMenuBaseController: UITabBarController {
    ...
    private func loadTabBar() {
        let tabItems: [TabItem] = [.home, .calender, .profile]
...
//        customTabBar.isUserInteractionEnabled = true
        ...
        NSLayoutConstraint.activate([
            self.customTabBar.leadingAnchor.constraint(equalTo: tabBar.leadingAnchor, constant: 15),
            self.customTabBar.trailingAnchor.constraint(equalTo: tabBar.trailingAnchor, constant: -15),
            self.customTabBar.widthAnchor.constraint(equalToConstant: tabBar.frame.width),
            self.customTabBar.heightAnchor.constraint(equalToConstant: tabBarHeight), // Fixed height for nav menu
            self.customTabBar.bottomAnchor.constraint(equalTo: tabBar.bottomAnchor, constant: -34)
        ])
